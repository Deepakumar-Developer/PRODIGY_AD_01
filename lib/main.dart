...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget coloredCalculatorButton(String buttonText,
      {Color textColor = Colors.white, Color buttonColor = Colors.grey}) {
    return Expanded(
        child: Padding(
                ...
                child: Column(
                  children: [
                    Expanded(
                      ...
                      child: Row(
                        children: [
                          coloredCalculatorButton("CLEAR",
                              buttonColor: Colors.red),
                          coloredCalculatorButton("DEL",
